...
const {
  RedLotusCurrent
} = require('./shared'); // 如果没有目录则创建，参考 outputFileSync https://github.com/jprichardson/node-fs-extra/blob/a149f822c387958caba7333ad2830615ab8b078f/lib/output/index.js
  ...
  const fileInstance = {
    ...
    appendChild(child) {
      if (this !== fileInstance) {
        throw Error(`You can only call 'appendChild' by 'fileInstance.appendChild(...), anything else which` + `will change the 'this' pointer will throw an error.`);
      }
